...
메모리: 78100 KB, 시간: 4696 ms

### 분류

수학, 구현, 그래프 이론, 문자열, 그래프 탐색, 애드 혹, 트리, 정수론, 해 구성하기, 많은 조건 분기, 깊이 우선 탐색, 비트마스킹, 백트래킹, 파싱, 분할 정복, 소수 판정, 재귀, 런타임 전의 전처리, 에라토스테네스의 체

### 제출 일자

2026년 4월 15일 15:50:25
